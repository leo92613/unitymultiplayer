...
namespace Medivis.Network {
    ...
    public class MedivisNetworkManager : BaseMedivisNetworkManager
    {
        ...
        public NetworkDiscoverServer discoveryServer;
        public NetworkDiscoverClient discoveryClient;
        public ConnectionHandler handler;
        public BaseNetworkPlayer localPlayer;
        ...
        public int HighestConnectedVersion()
        {
            ...
            foreach (BaseNetworkPlayer p in LobbyPlayers())
            {
        ...
        public List<BaseNetworkPlayer> LobbyPlayers()
        {
            var lobbyPlayers = new List<BaseNetworkPlayer>();
        ...
        public override void OnLobbyClientEnter()
        {
            if (verboseLogging)
            {
                Debug.Log("#CaptainsMess# OnLobbyClientEnter " + handler);
            }
        ...
        {
            handler.OnCountdownStarted();
        }

        public void SendCountdownCancelledMessage()
        {
            handler.OnCountdownCancelled();
        }

        public void SendStartGameMessage(List<BaseNetworkPlayer> aStartingPlayers)
        {
            handler.OnStartGame(aStartingPlayers);
        }

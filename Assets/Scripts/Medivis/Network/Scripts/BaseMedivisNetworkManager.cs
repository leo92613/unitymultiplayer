...
{
    public class BaseMedivisNetworkManager : NetworkManager
    {
        public int minPlayers = 1;
        public int maxPlayers = 10;
        public BaseNetworkPlayer[] lobbySlots;
        ...
        public override void OnStartServer()
        {
            ...
            {
                lobbySlots = new BaseNetworkPlayer[maxPlayers];
            }
        }
        ...
        {
            byte slot = player.gameObject.GetComponent<BaseNetworkPlayer>().slot;
        ...
        {
            OnLobbyClientEnter();
            foreach (BaseNetworkPlayer player in lobbySlots)
            {
                if (player == null)
                    continue;
